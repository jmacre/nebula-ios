...
public class GameElements {
    ...
    public static final String GEM_75K_SKU = "75k_g";
    public static final String GEM_200K_SKU = "200k_g";
    public static final String GEM_500K_SKU = "500k_g";
    ...
    public static float BACK_BUTTON_WIDTH;
    public static float BACK_BUTTON_HEIGHT;
    public static float BACK_BUTTON_X;
    public static float BACK_BUTTON_Y;

    public static float QUESTION_BUTTON_WIDTH;
    public static float QUESTION_BUTTON_HEIGHT;
    public static float QUESTION_BUTTON_X;
    public static float QUESTION_BUTTON_Y;
    ...
    public static void defineSizesAndPositions(){
        ...
        BACK_BUTTON_WIDTH = SHOP_BACK_WIDTH / 10f;
        BACK_BUTTON_HEIGHT = (float) (BACK_BUTTON_WIDTH * .813);
        BACK_BUTTON_X = SHOP_BACK_X + BACK_BUTTON_WIDTH/3;
        BACK_BUTTON_Y = SHOP_BACK_Y + SHOP_BACK_HEIGHT - BACK_BUTTON_HEIGHT*1.5f;
        ...
        QUESTION_BUTTON_HEIGHT = TS_SOUND_BUTTON_HEIGHT;
        QUESTION_BUTTON_WIDTH = QUESTION_BUTTON_HEIGHT;
...
//        BULLET_BUTTON_Y = SHOP_BACK_Y + (SHOP_BACK_HEIGHT/ 2) - BULLET_BUTTON_HEIGHT/2;
        ...
        GEM_ICON_SHOP_X = SHOP_BACK_X + SHOP_BACK_WIDTH*.7f;
        GEM_ICON_SHOP_Y = BACK_BUTTON_Y + BACK_BUTTON_HEIGHT/2 - GEM_ICON_HEIGHT/2;
