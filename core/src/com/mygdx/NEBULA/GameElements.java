...
public class GameElements {
    ...
    public static final float TITLE_LOGO_WIDTH = (SCREEN_WIDTH / ASPECT_RATIO)/2 * 1.1f;
    ...
    public static final float X_BUTTON_WIDTH = SHOP_BACK_WIDTH / 9;
    ...
    public static final float START_BUTTON_WIDTH = (float)(SCREEN_WIDTH/ASPECT_RATIO)/2;
    ...
    public static final float SHOP_BUTTON_WIDTH = (SCREEN_WIDTH/ASPECT_RATIO)/3f;
